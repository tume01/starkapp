...
class MembershipApplicationForm(forms.Form):
    ...
    birthDate = forms.DateField(error_messages={'required': 'El campo Fecha de nacimiento es requerido'}, input_formats=['%m/%d/%Y'])
    sbirthDate = forms.DateField(error_messages={'required': 'El campo Fecha de nacimiento es requerido'}, input_formats=['%m/%d/%Y'])
    ...
    sfirstName = forms.CharField(max_length=20, validators=[alphabetic], error_messages={'max_length': 'El campo Nombres debe tener una longitud maxima de 20 caracteres'})
    spaternalLastName = forms.CharField(max_length=20, validators=[alphabetic], error_messages={'max_length': 'El campo Apellido paterno debe tener una longitud maxima de 20 caracteres'})
    smaternalLastName = forms.CharField(max_length=20, validators=[alphabetic], error_messages={'max_length': 'El campo Apellido materno debe tener una longitud maxima de 20 caracteres'})
    sspecialization = forms.CharField(max_length=200, error_messages={'max_length': 'El campo Especialización no debe superar los 200 caracteres'})
    snationality = forms.CharField(max_length=20, error_messages={'max_length': 'El campo Nacionalidad no debe superar los 20 caracteres'})
    sbirthPlace = forms.CharField(max_length=200, error_messages={'max_length': 'El campo Lugar de nacimiento no debe superar los 200 caracteres'})
    sworkPlace = forms.CharField(max_length=200, error_messages={'max_length': 'El campo Centro de trabajo no debe superar los 200 caracteres'})
    sworkPlaceJob = forms.CharField(max_length=200, error_messages={'max_length': 'El campo Puesto de trabajo no debe superar los 200 caracteres'})
    semail = forms.CharField(max_length=200, error_messages={'max_length': 'El campo Correo no debe superar los 200 caracteres'})
